...
const DOMAIN_NAME = "xiaolin2004.github.io"; // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    "/": {
      lang: "zh-CN",
      title: "DonkeyKane's blog",
      description: "",
    },
  },
  base: "/my_blog/", // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  ...
  themeConfig: {
    ...
    repo: "xiaolin2004/my_blog", // 导航栏右侧生成Github链接
    ...
    author: {
      name: "DonkeyKane", // 必需
      link: "https://github.com/xiaolin2004", // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar:
        "https://avatars.githubusercontent.com/u/109840258?s=400&u=d2b35e387efd55050f834d5663235ac2e5f73e71&v=4",
      name: "DonkeyKane",
      slogan: "",
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'DonkeyKane | <a href="https://github.com/xiaolin2004/my_blog/blob/main/LICENSE" target="_blank">MIT License</a> ', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
